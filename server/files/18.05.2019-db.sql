...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 18 2019 г., 18:35
...
(2, 1, '1.2 Вибіркові навчальні дисципліни', 10),
...
INSERT INTO `education_items` (`education_item_id`, `sub_category_id`, `category_id`, `cycles_id`, `education_plans_id`, `subject_id`, `credits`, `lectures`, `laboratories`, `choice`) VALUES
(131, NULL, 1, 1, 1, 1, 5, 0, 0, 0),
(132, NULL, 1, 1, 1, 2, 5, 32, 0, 0),
(133, NULL, 1, 1, 1, 3, 5, 0, 0, 0),
(134, NULL, NULL, 3, 1, 14, 10, 0, 0, 0);
...
CREATE TABLE `education_plans` (
  ...
  `cloned_plan_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `education_plans` (`id`, `user_id`, `department_id`, `name`, `status`, `year`, `created_at`, `cloned_plan_id`) VALUES
(1, 1, 1, 'ПЛАН НАВЧАЛЬНОГО ПРОЦЕСУ', 'created', 2019, '2019-05-06 21:00:00', NULL),
(24, 1, 2, '1', 'created', 2018, '2019-05-18 14:26:26', NULL);
...
(13, 'Вибіркові дисципліни інших спеціальностей  (додаток 2) '),
(14, 'Практика'),
(15, 'Кваліфікаційна робота бакалавра'),
(16, 'Атестаційний кваліфікаційний іспит'),
(17, 'Вибіркові дисципліни за спеціальністю');
...
(1, 3, '2.1.1 Обов’язкові навчальні дисципліни за спеціальністю', 50)
...
--
ALTER TABLE `distribution_of_hours`
  MODIFY `distribution_of_hours_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT для таблицы `education_items`
--
ALTER TABLE `education_items`
  MODIFY `education_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=135;
...
--
ALTER TABLE `subdivisions`
  MODIFY `subdivision_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
