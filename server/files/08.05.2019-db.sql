...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 08 2019 г., 11:25
...
(8, 1, 1, 'План 5', 'created', 2019, '2019-05-06 21:00:00');
...
--
ALTER TABLE `distribution_of_controls`
  MODIFY `distribution_of_controls_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `subdivisions`
  MODIFY `subdivision_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
